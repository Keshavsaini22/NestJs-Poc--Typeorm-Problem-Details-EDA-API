...
export class RabbitmqConfigService {
  ...
  private config: ConfigType = {
    ...
    primaryQueue: this.configService.get<string>(
      'RABBITMQ_PRIMARY_QUEUE_PATIENT',
    ),
    retryQueue: this.configService.get<string>('RABBITMQ_RETRY_QUEUE_PATIENT'),
    retryBindingKey: this.configService.get<string>(
      'RABBITMQ_RETRY_BINDING_KEY_PATIENT',
    ),
