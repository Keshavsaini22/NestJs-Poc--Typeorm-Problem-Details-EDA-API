...
export class RabbitmqConfigService {
  ...
  private config: ConfigType = {
    ...
    primaryQueue: this.configService.get<string>('RABBITMQ_PRIMARY_QUEUE_TEST'),
    retryQueue: this.configService.get<string>('RABBITMQ_RETRY_QUEUE_TEST'),
    retryBindingKey: this.configService.get<string>(
      'RABBITMQ_RETRY_BINDING_KEY_TEST',
    ),
